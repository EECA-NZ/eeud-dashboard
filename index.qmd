...
```
<div style="flex-grow: 1; text-align: right;"><p style="font-size: 1rem; padding-top: 1rem; line-height: 0px;">Values presented for 2022</p></div>
...
def display_overview_energy_use():
    ...
    fig.update_traces(marker_colors=[eeud_colours[parent] for parent in fig.data[-1].labels])
    fig.update_traces(marker=dict(line=dict(color='rgba(232,236,238,255)', width=0)),
...
def display_timeseries_chart():
    ...
    if input.timeseries_display() == "Proportional":
        ...
        timeseries_df['TJ'] = timeseries_df['TJ'] / timeseries_df['TotalTJ']
