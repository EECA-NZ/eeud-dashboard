...
def apply_common_plotly_layout(fig, height=MIN_PLOT_HEIGHT):
    ...
    fig.update_layout(
        ...
        modebar_color="rgba(22,64,87,255)",
        paper_bgcolor="rgba(232,236,238,255)",
        plot_bgcolor="rgba(232,236,238,255)",
...
@render.data_frame
def dataview():
    return render.DataGrid(data_eeud_filtered().drop(['SectorANZSIC', 'PeriodEndDate', 'Transport'], axis=1), height=MIN_PLOT_HEIGHT, width="100%", summary=False)
```
